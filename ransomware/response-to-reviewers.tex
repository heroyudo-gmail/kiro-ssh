...
are now referenced in the text before they appear. Energy profiling and a direct comparison with
deduplication/incremental backup remain listed as future work.}
\loc{Section~4 (new statistical-analysis subsection, Table on compression statistics; all figure references) and Section~5 (remaining future work).}
