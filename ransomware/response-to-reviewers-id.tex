...
\end{revbox}
\authors{Kami melaporkan hasil terukur per tipe berkas untuk kelima algoritma dan skor efisiensi
gabungan. Semua gambar kini dirujuk di teks sebelum ditampilkan. Kami secara jujur mencatat bahwa
statistik uji-berulang, profil CPU/RAM/\textit{throughput}/energi, dan perbandingan langsung dengan
deduplikasi/incremental backup adalah pengembangan penting; hal ini dicantumkan secara eksplisit
sebagai arah penelitian mendatang alih-alih diklaim. Kami memilih menyatakan keterbatasan ini
secara jujur daripada menyajikan angka yang belum terverifikasi.}
\loc{Bagian~4 (hasil kompresi, seluruh rujukan gambar) dan Bagian~5 (arah penelitian mendatang).}
...
\end{revbox}
\authors{Kami memperkuat dasar empiris dengan menjalankan ulang eksperimen penuh pada dua platform
(Windows Server 2022 dan Ubuntu 22.04 di AWS EC2), melaporkan kompresi per tipe untuk lima
algoritma serta tabel konsistensi lintas-platform. Profil statistik yang lebih dalam (uji berulang,
CPU/RAM/\textit{throughput}) dicantumkan sebagai arah penelitian mendatang alih-alih diklaim tanpa data.}
\loc{Bagian~4 (subbagian lintas-platform dan tabel konsistensi) dan Bagian~5 (arah penelitian mendatang).}
