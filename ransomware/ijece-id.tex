...
Lingkungan lokal Windows merepresentasikan konfigurasi konsumen berkinerja menengah-ke-tinggi yang umum digunakan pada sistem cadangan perusahaan, sedangkan lingkungan AWS EC2 merepresentasikan penerapan \textit{cloud} nyata. Pada lingkungan \textit{cloud}, media \textit{air-gapped} diwujudkan sebagai volume EBS terpisah yang hanya di-\textit{mount} saat proses cadangan/pemulihan, meniru isolasi logis media pada lingkungan lokal. Penggunaan dua lingkungan memungkinkan verifikasi bahwa hasil sistem bersifat \textbf{konsisten lintas-platform}, sekaligus menjawab keterbatasan generalisasi yang lazim pada penelitian yang hanya diuji pada satu platform.
