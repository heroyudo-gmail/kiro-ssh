...
\twocolumn[
  ...
  \begin{center}
    ...
    \vspace{4pt}
    {\fontsize{10}{12}\selectfont (Naskah masuk: dd mmm yyyy, diterima untuk diterbitkan: dd mmm yyyy)\par}
    \vspace{10pt}
  \end{center}
...
Top-10 & 0,9717 & 0,9865 & 5,65 MB & 0,1826 s \\ \bottomrule
\end{tabularx}
\end{table}
...
S4 & Robust & Manip. & 0,9953 & 0,9985 & 0,9985 \\ \bottomrule
\end{tabularx}
\end{table}
...
RT-S4 (Robust+Evasi) & 0,9953 & 0,389 & 0,9985 & 0,626 \\ \bottomrule
\end{tabularx}
\end{table}
